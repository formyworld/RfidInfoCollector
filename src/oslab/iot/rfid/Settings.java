...
public class Settings {
	   ...
	   public static final int SPAN_READ = 4*1000;//RFID Reader读取周期
	   public static final int DELAY_JUDGE = 5*1000; //RFID SOURCE JUDGE延迟时间
	   public static final int SPAN_JUDGE = 10*1000; //RFID SOURCE JUDGE处理周期
	   
	   public static final int SPAN_DEAL_DIFF = 10*1000; //RFID STATUS DEAL CHANGE RFID状态变换信息处理周期
	   
	   public static final int THRESHOLD_IS_OUT = 5*60*1000; //判断是否离开监听范围
	   
	   public static final int SPAN_ROUTINE = 30*60*1000; //例行插入状态信息  周期
	   public static final int DELAY_ROUTINE = 30*60*1000; //例行插入状态信息 延迟时间
